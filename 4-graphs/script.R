...
##################################################################
# Exercise 1 : Create the network of NYC's districts, where there is an edge if and only if there are more taxi trips 
# between the two districts than the average number of taxi trips between two districts (hint: use filter)
...
# The new absent is the Bronx. Can you see an airport ?
